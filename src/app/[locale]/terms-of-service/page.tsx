...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.carflipper.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Car Flipper Wiki",
    description: "Read the Terms of Service for Car Flipper Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Car Flipper Wiki",
      title: "Terms of Service - Car Flipper Wiki",
      description: "Terms and conditions for using Car Flipper Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Car Flipper Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Car Flipper Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Car Flipper Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Car Flipper Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Car Flipper Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Car Flipper". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and profit strategies</li>
              <li>Codes, repair, and tuning shop guides</li>
              <li>Vehicle and car database information</li>
              <li>Workshop expansion and racing guides</li>
              <li>In-game milestone walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Car Flipper Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation (Roblox) or the official developers of Car Flipper. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Car Flipper Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation (Roblox) and/or the developers of Car Flipper. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Game content and updates may change without notice. We are not responsible for game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, CAR FLIPPER WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, YouTube, social media platforms,
            ...
            <p>
              ...
              you and Car Flipper Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@carflipper.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@carflipper.wiki</a>
            </p>
            <p>
